...
#undef EX2MSG
	...
	bool UserInterface::ProcessCommandLine ()
	{
		...
		case CommandId::ChangePassword:
			ChangePassword (cmdLine.ArgVolumePath, cmdLine.ArgPassword, cmdLine.ArgPim, cmdLine.ArgHash, cmdLine.ArgKeyfiles, cmdLine.ArgNewPassword, cmdLine.ArgNewPim, cmdLine.ArgNewKeyfiles, cmdLine.ArgNewHash, cmdLine.ArgExtSaltPath);
			return true;
		...
		case CommandId::DisplayVersion:
			ShowString (Application::GetName() + L" " + StringConverter::ToWide (Version::String()) + L" Edition 63585-1"  +  L"\n");
			return true;
