...
namespace VeraCrypt
{
	...
	public:
		...
		static void GetDataFix (const BufferPtr &buffer, bool allowAnyLength = false) { GetDataFix (buffer, false, allowAnyLength); }
	...
	protected:
		...
		static void GetDataFix (const BufferPtr &buffer, bool fast, bool allowAnyLength);
